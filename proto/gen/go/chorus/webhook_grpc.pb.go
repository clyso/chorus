...
func (c *webhookClient) SwiftEvents(ctx context.Context, in *SwiftEventsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Webhook_SwiftEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWebhookServer) SwiftEvents(context.Context, *SwiftEventsRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SwiftEvents not implemented")
}
func (UnimplementedWebhookServer) S3Notifications(context.Context, *S3NotificationRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method S3Notifications not implemented")
}
...
func _Webhook_SwiftEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SwiftEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebhookServer).SwiftEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Webhook_SwiftEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebhookServer).SwiftEvents(ctx, req.(*SwiftEventsRequest))
	}
