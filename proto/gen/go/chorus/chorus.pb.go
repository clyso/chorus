...
var file_chorus_chorus_proto_depIdxs = []int32{
	...
	31, // 20: chorus.GetAgentsResponse.agents:type_name -> chorus.Agent
	24, // 21: chorus.SwitchBucketZeroDowntimeRequest.replication_id:type_name -> chorus.ReplicationRequest
	38, // 22: chorus.SwitchBucketZeroDowntimeRequest.multipart_ttl:type_name -> google.protobuf.Duration
	24, // 23: chorus.SwitchBucketRequest.replication_id:type_name -> chorus.ReplicationRequest
	34, // 24: chorus.SwitchBucketRequest.downtime_opts:type_name -> chorus.SwitchDowntimeOpts
	37, // 25: chorus.SwitchDowntimeOpts.start_at:type_name -> google.protobuf.Timestamp
	38, // 26: chorus.SwitchDowntimeOpts.max_duration:type_name -> google.protobuf.Duration
	1,  // 27: chorus.GetBucketSwitchStatusResponse.last_status:type_name -> chorus.GetBucketSwitchStatusResponse.Status
	38, // 28: chorus.GetBucketSwitchStatusResponse.multipart_ttl:type_name -> google.protobuf.Duration
	34, // 29: chorus.GetBucketSwitchStatusResponse.downtime_opts:type_name -> chorus.SwitchDowntimeOpts
	37, // 30: chorus.GetBucketSwitchStatusResponse.last_started_at:type_name -> google.protobuf.Timestamp
	37, // 31: chorus.GetBucketSwitchStatusResponse.done_at:type_name -> google.protobuf.Timestamp
	24, // 32: chorus.GetBucketSwitchStatusResponse.replication_id:type_name -> chorus.ReplicationRequest
	35, // 33: chorus.ListSwitchResponse.switches:type_name -> chorus.GetBucketSwitchStatusResponse
	39, // 34: chorus.Chorus.GetAppVersion:input_type -> google.protobuf.Empty
	39, // 35: chorus.Chorus.GetStorages:input_type -> google.protobuf.Empty
	39, // 36: chorus.Chorus.GetProxyCredentials:input_type -> google.protobuf.Empty
	20, // 37: chorus.Chorus.ListBucketsForReplication:input_type -> chorus.ListBucketsForReplicationRequest
	18, // 38: chorus.Chorus.AddReplication:input_type -> chorus.AddReplicationRequest
	39, // 39: chorus.Chorus.ListReplications:input_type -> google.protobuf.Empty
	39, // 40: chorus.Chorus.ListUserReplications:input_type -> google.protobuf.Empty
	24, // 41: chorus.Chorus.StreamBucketReplication:input_type -> chorus.ReplicationRequest
	24, // 42: chorus.Chorus.PauseReplication:input_type -> chorus.ReplicationRequest
	24, // 43: chorus.Chorus.ResumeReplication:input_type -> chorus.ReplicationRequest
	24, // 44: chorus.Chorus.DeleteReplication:input_type -> chorus.ReplicationRequest
	27, // 45: chorus.Chorus.DeleteUserReplication:input_type -> chorus.DeleteUserReplicationRequest
	32, // 46: chorus.Chorus.SwitchBucketZeroDowntime:input_type -> chorus.SwitchBucketZeroDowntimeRequest
	33, // 47: chorus.Chorus.SwitchBucket:input_type -> chorus.SwitchBucketRequest
	24, // 48: chorus.Chorus.DeleteBucketSwitch:input_type -> chorus.ReplicationRequest
	24, // 49: chorus.Chorus.GetBucketSwitchStatus:input_type -> chorus.ReplicationRequest
	39, // 50: chorus.Chorus.ListReplicationSwitches:input_type -> google.protobuf.Empty
	28, // 51: chorus.Chorus.CompareBucket:input_type -> chorus.CompareBucketRequest
	39, // 52: chorus.Chorus.GetAgents:input_type -> google.protobuf.Empty
	19, // 53: chorus.Chorus.AddBucketReplication:input_type -> chorus.AddBucketReplicationRequest
	24, // 54: chorus.Chorus.GetReplication:input_type -> chorus.ReplicationRequest
	3,  // 55: chorus.Chorus.StartConsistencyCheck:input_type -> chorus.StartConsistencyCheckRequest
	39, // 56: chorus.Chorus.ListConsistencyChecks:input_type -> google.protobuf.Empty
	4,  // 57: chorus.Chorus.GetConsistencyCheckReport:input_type -> chorus.ConsistencyCheckRequest
	11, // 58: chorus.Chorus.GetConsistencyCheckReportEntries:input_type -> chorus.GetConsistencyCheckReportEntriesRequest
	4,  // 59: chorus.Chorus.DeleteConsistencyCheckReport:input_type -> chorus.ConsistencyCheckRequest
	13, // 60: chorus.Chorus.GetAppVersion:output_type -> chorus.GetAppVersionResponse
	14, // 61: chorus.Chorus.GetStorages:output_type -> chorus.GetStoragesResponse
	17, // 62: chorus.Chorus.GetProxyCredentials:output_type -> chorus.GetProxyCredentialsResponse
	21, // 63: chorus.Chorus.ListBucketsForReplication:output_type -> chorus.ListBucketsForReplicationResponse
	39, // 64: chorus.Chorus.AddReplication:output_type -> google.protobuf.Empty
	22, // 65: chorus.Chorus.ListReplications:output_type -> chorus.ListReplicationsResponse
	25, // 66: chorus.Chorus.ListUserReplications:output_type -> chorus.ListUserReplicationsResponse
	23, // 67: chorus.Chorus.StreamBucketReplication:output_type -> chorus.Replication
	39, // 68: chorus.Chorus.PauseReplication:output_type -> google.protobuf.Empty
	39, // 69: chorus.Chorus.ResumeReplication:output_type -> google.protobuf.Empty
	39, // 70: chorus.Chorus.DeleteReplication:output_type -> google.protobuf.Empty
	39, // 71: chorus.Chorus.DeleteUserReplication:output_type -> google.protobuf.Empty
	39, // 72: chorus.Chorus.SwitchBucketZeroDowntime:output_type -> google.protobuf.Empty
	39, // 73: chorus.Chorus.SwitchBucket:output_type -> google.protobuf.Empty
	39, // 74: chorus.Chorus.DeleteBucketSwitch:output_type -> google.protobuf.Empty
	35, // 75: chorus.Chorus.GetBucketSwitchStatus:output_type -> chorus.GetBucketSwitchStatusResponse
	36, // 76: chorus.Chorus.ListReplicationSwitches:output_type -> chorus.ListSwitchResponse
	29, // 77: chorus.Chorus.CompareBucket:output_type -> chorus.CompareBucketResponse
	30, // 78: chorus.Chorus.GetAgents:output_type -> chorus.GetAgentsResponse
	39, // 79: chorus.Chorus.AddBucketReplication:output_type -> google.protobuf.Empty
	23, // 80: chorus.Chorus.GetReplication:output_type -> chorus.Replication
	39, // 81: chorus.Chorus.StartConsistencyCheck:output_type -> google.protobuf.Empty
	6,  // 82: chorus.Chorus.ListConsistencyChecks:output_type -> chorus.ListConsistencyChecksResponse
	8,  // 83: chorus.Chorus.GetConsistencyCheckReport:output_type -> chorus.GetConsistencyCheckReportResponse
	12, // 84: chorus.Chorus.GetConsistencyCheckReportEntries:output_type -> chorus.GetConsistencyCheckReportEntriesResponse
	39, // 85: chorus.Chorus.DeleteConsistencyCheckReport:output_type -> google.protobuf.Empty
